...
public class ChannelFullReadModel : Impl.ChannelFullReadModel
{
}


public class ChannelMemberReadModel : Impl.ChannelMemberReadModel
{
}
...
public class DeviceReadModel : Impl.DeviceReadModel
{
}


public class DialogFilterReadModel : Impl.DialogFilterReadModel
{
}
...
public class DraftReadModel : Impl.DraftReadModel
{
}
...
public class PtsForAuthKeyIdReadModel : Impl.PtsForAuthKeyIdReadModel
{
}


public class PtsReadModel : Impl.PtsReadModel
{
}


public class PushDeviceReadModel : Impl.PushDeviceReadModel
{
}

//
//public class PushUpdatesReadModel : Impl.PushUpdatesReadModel
//{
//}


public class ReadingHistoryReadModel : Impl.ReadingHistoryReadModel
{
}

public class ReplyReadModel : Impl.ReplyReadModel
{
}


public class RpcResultReadModel : Impl.RpcResultReadModel
{
}
